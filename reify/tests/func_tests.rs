use reify::{Expr, Table, Value, func};
...
fn func_count_column() {
    let (sql, params) = User::find().select_expr(&[func::count(User::id)]).build();
...
#[test]
fn func_count_all() {
    let (sql, params) = User::find().select_expr(&[func::count_all()]).build();
...
#[test]
fn func_sum() {
    let (sql, params) = User::find().select_expr(&[func::sum(User::score)]).build();
...
#[test]
fn func_avg() {
    let (sql, params) = User::find().select_expr(&[func::avg(User::score)]).build();
...
#[test]
fn func_min() {
    let (sql, params) = User::find().select_expr(&[func::min(User::score)]).build();
...
#[test]
fn func_max() {
    let (sql, params) = User::find().select_expr(&[func::max(User::id)]).build();
...
#[test]
fn func_upper() {
    let (sql, params) = User::find().select_expr(&[func::upper(User::name)]).build();
...
#[test]
fn func_lower() {
    let (sql, params) = User::find().select_expr(&[func::lower(User::name)]).build();
...
#[test]
fn func_abs() {
    let (sql, params) = User::find().select_expr(&[func::abs(User::score)]).build();
